...
export const CheckOut = () => {
    ...
    const Checkout = useSelector((store) => store.AppReducer.CartData);
  ...
  return (
    <>
      <Box  height={{base :'100px'}}></Box>
          <Flex  direction={{base :'column', md :'row'}} w={{base :'95%', md :'95%', lg :'95%'}} rowGap='30px' m='auto'
           mt="-20"
          > 
            ...
            <Box w={{base : '100%', md :'40%', lg : '30%'}}>
                ...
                {Checkout.length > 0 &&  Checkout.map((elem)=>{
                    return (
                        <Flex  mt='20px'>
